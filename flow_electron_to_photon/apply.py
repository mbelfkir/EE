...
def main() -> None:
    parser = argparse.ArgumentParser(description="Apply saved fold checkpoints to electron ROOT inputs.")
    parser.add_argument(
        "--configpath",
        default=str((Path(__file__).resolve().parent / "configs" / "config_apply.yaml").resolve()),
