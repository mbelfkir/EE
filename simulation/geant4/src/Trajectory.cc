...
// ********************************************************************
//
/// \file Geant4-models/ATLAS-simplified/src/Trajectory.cc
...
G4ThreadLocal G4Allocator<CaloRTrajectory> * myTrajectoryAllocator = 0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
CaloRTrajectory::CaloRTrajectory(const G4Track* aTrack)
:G4VTrajectory(),
 fPositionRecord(0),fParticleDefinition(0),
 fOriginCharge(-999), fOriginPDGEncoding(0)
{
   ...
   fTrackStatus = aTrack->GetTrackStatus();
   fPositionRecord = new CaloRTrajectoryPointContainer();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
CaloRTrajectory::~CaloRTrajectory()
{
  size_t i;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void CaloRTrajectory::ShowTrajectory(std::ostream& os) const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void CaloRTrajectory::DrawTrajectory() const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
const std::map<G4String,G4AttDef>* CaloRTrajectory::GetAttDefs() const
{
  G4bool isNew;
  std::map<G4String,G4AttDef>* store
    = G4AttDefStore::GetInstance("CaloRTrajectory",isNew);
  if (isNew) {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
std::vector<G4AttValue>* CaloRTrajectory::CreateAttValues() const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void CaloRTrajectory::AppendStep(const G4Step* aStep)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void CaloRTrajectory::MergeTrajectory(G4VTrajectory* secondTrajectory)
{
  if(!secondTrajectory) return;

  CaloRTrajectory* seco = (CaloRTrajectory*)secondTrajectory;
