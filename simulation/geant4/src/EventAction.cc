...
G4double CaloREventAction::CalibrateCellEnergy(G4double de, G4String c_name, G4int DynParflag)
{
 ...
 // All heavy nuclei treated as carbons
  ...
  // cell EM calibration:
  if(c_name.find("ECAL") != G4String::npos){
	  de*=ECAL_cell_calib;
  }
  else{
